 ...
 */
layui.config({
    base: '../../../../layuiadmin/layui/extend/cropper/' //layui自定义layui组件目录
        ...
        render: function(e){
            ...
            $(".layui-btn").on('click',function () {
                ...
                if(event === 'confirmSave'){
                    ...
                    //     });
                    // });
                    let data=   image.cropper("getCroppedCanvas",{
                        width: saveW,
                        height: saveH
                    })

                    let blob = processData(data.toDataURL());
                        var formData=new FormData();
                        formData.append('file',blob,'head.jpg');
                        console.log(formData,'使用二进制方式处理dataUrl');
                        $.ajax({
                            method:"post",
                            url: url, //用于文件上传的服务器端请求地址
                            beforeSend:function(){

                ...
                var TIPS = '请选择', CLASS = 'layui-form-select', TITLE = 'layui-select-title'
                    ...
                    ,events = function(reElem, disabled, isSearch){
                        ...
                        var myFilter = function(value, text, id) {
                            ...
                            //         result =
                            //             // ConvertPinyin(text).substring(0, len) === value ||
                            ...
                            if (escape(value).indexOf("%u") != -1) { //汉字
                                ...
                                try {
                                    result =
                                        // ConvertPinyin(text).substring(0, len) === value ||
                                        // makePy(text)[0].toLowerCase().substring(0, len) === value ||
                                        ConvertPinyin(text).indexOf(value)>-1 ||
                                        makePy(text)[0].toLowerCase().indexOf(value)>-1 ||
                                        text.toLowerCase().indexOf(value) > -1 ||
                                        (id === undefined ? false : id.indexOf(value) > -1);
                                }catch (e) {
                                    console.log('请检查拼音文件是否引入');
                                }
